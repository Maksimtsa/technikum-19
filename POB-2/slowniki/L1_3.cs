            ...
            while (true)
            {
                ...
                switch (choice)
                {
                    ...
                    case "5":
                        ...
                        break;
                    case "6":
                        Console.WriteLine("Podaj tłumaczenie do wyszukania: ");
                        string reverseSearchValue = Console.ReadLine();
                        List<string> matchingKeys = new List<string>();

                        foreach (var pair in translations)
                        {
                            if (pair.Value.Contains(reverseSearchValue))
                            {
                        ...
                        {
                            Console.WriteLine($"Tłumaczenie {reverseSearchValue} odpowiada słowom: {string.Join(", ", matchingKeys)}");
                        }
                        else
                        {
                            Console.WriteLine("Nie znaleziono słów odpowiadających temu tłumaczeniu.");
                        }
                        break;
                    case "7":
